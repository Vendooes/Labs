...
% Блок с подписями
\noindent
Работу выполнил \hfill \underline{\hspace{6cm}} Т.А.Закатова Б04-407 \\
\hfill \small{(подпись, дата)}\par
...
% Блок с подписями
\noindent
Работу выполнил \hfill \underline{\hspace{6cm}} М.А.Кручинин Б04-407 \\
\hfill \small{(подпись, дата)}\par
